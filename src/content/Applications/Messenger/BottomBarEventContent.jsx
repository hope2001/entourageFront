...
import { useAddEventDiscuss } from '@/Services/Query/chatEventQuery';
  ...
  function BottomBarEventContent({ converse, setConverse, chatLoad, setchatLoad, response, setResponse, error, setError,inter, setinter, setquery,chat_id,setchat_id}) {
      ...
      const onSubmit = async (data, e) => {
        ...
        try {
         const query = data.query
          ...
          const apiUrlfull = ia_api+"chatbot_event?query="+query+"&json_data="+JSON.stringify(inter.slice(-3))
  ...
  export default BottomBarEventContent;
