...
function Table_EventConverse({ dashData }) {
  // Use the usePagination hook to paginate the data
  const [show, setShow] = useState(false);
  const [mdata, setMdata] = useState({});
  const { currentPage, totalPages, paginatedData, setCurrentPage } = usePagination(dashData?.eventconversesstats?.converses, 10);
...
export default Table_EventConverse;
